module ReductionMsg
{
    ...
    proc countReductionMsg(reqMsg: bytes, st: borrowed SymTab): bytes throws {
        param pn = Reflection.getRoutineName();
    ...
    proc countLocalRdxMsg(reqMsg: bytes, st: borrowed SymTab): bytes throws {
        param pn = Reflection.getRoutineName();
    ...
    proc segmentedReductionMsg(reqMsg: bytes, st: borrowed SymTab): bytes throws {
        param pn = Reflection.getRoutineName();
      // reqMsg: segmentedReduction values segments operator
      var fields = reqMsg.split();
      var cmd = fields[1];
    ...
    proc segmentedLocalRdxMsg(reqMsg: bytes, st: borrowed SymTab): bytes throws {
        param pn = Reflection.getRoutineName();
